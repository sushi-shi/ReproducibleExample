...
class TestConnection {
    ...
    async loadProgram(sopath: string): Promise<PublicKey> {
    ...
    async getContract(programId: PublicKey, abi_path: string, contractStorageSize: number = 2048) {
        const abi: string = fs.readFileSync(abi_path, 'utf-8');
